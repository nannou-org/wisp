...
```sh
cargo run -p bevy_wisp --example ui --features ui,bevy/file_watcher
```

For a self-contained live-coding setup, the `wisp_editor` crate pairs a
